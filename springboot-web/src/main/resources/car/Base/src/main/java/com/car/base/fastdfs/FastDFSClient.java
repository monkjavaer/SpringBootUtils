...
//            }
     ...
     * @return
     */
    public static String uploadFileByURL(String photoUrl) throws Exception{
        //try {
...
/*        }catch (Exception e){
    ...
    public static String uploadFileByURL(byte[] photoData) throws Exception{
        ...
        metaList.put("fileName", fileName);
        metaList.put("fileExtName", "jpg");
        metaList.put("fileLength", String.valueOf(photoData.length));
        return uploadFile(photoData, fileName,metaList);
    }
     ...
     * @return
     */
    public static String uploadFile(byte[] fileContent, String fileName, Map<String,String> metaList) throws Exception{
       // try {
...
/*        } catch (Exception e) {
    ...
    public static void main(String[] args) {
        String fastDFSUrl = "group1/M00/00/00/wKgT_lzvtOyALOgdAB0dWRQIHso325.jpg";
        System.out.println(fastDFSUrl.substring(0,fastDFSUrl.indexOf("/")));
        System.out.println(fastDFSUrl.substring(fastDFSUrl.indexOf("/")+1));
        FastDFSClient.deleteFile(fastDFSUrl.substring(0,fastDFSUrl.indexOf("/")),fastDFSUrl.substring(fastDFSUrl.indexOf("/")+1));
    }
    /**
     *
     * @Title: deleteFile
     ...
     * @return: String
     */
    public static String modifyFile(String oldFileId, String fullPath) throws Exception{
        String fileid = null;
        try {
            // 先上传
