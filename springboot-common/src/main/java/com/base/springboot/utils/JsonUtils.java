...
public class JsonUtils {
    ...
    public static String toDateFormatJSONString(Object object){
        return JSON.toJSONStringWithDateFormat(object, DateTimeUtils.DEFAULT_TIME_FORMAT,FEATURES);
    }
    ...
    public static String toDateFormatJSONArrayString(Object object){
        return JSONArray.toJSONStringWithDateFormat(object, DateTimeUtils.DEFAULT_TIME_FORMAT, FEATURES);
    }
