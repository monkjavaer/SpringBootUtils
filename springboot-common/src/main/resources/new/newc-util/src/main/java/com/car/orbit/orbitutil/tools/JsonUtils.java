...
public class JsonUtils {
	...
	public static final String[] TIME_FORMAT = new String[]{"yyyy-MM-dd HH:mm:ss"};
	...
	public static String toDateFormatJSONString(Object object){
		return JSON.toJSONStringWithDateFormat(object, TIME_FORMAT[0],FEATURES);
	}
	...
	public static String toDateFormatJSONArrayString(Object object){
		return JSONArray.toJSONStringWithDateFormat(object, TIME_FORMAT[0], FEATURES);
	}
