package com.base.springboot.car.NodeService.src.main.java.com.car.netty.decode;
...
public class UnvDecode  extends ByteToMessageDecoder {

    /**
     * 日志组件.
     */
    private static Logger LOGGER = LoggerFactory.getLogger(UnvDecode.class);
     ...
     */
    public UnvDecode(int maxFrameLength, int lengthFieldOffset, int lengthFieldLength)
    {
     ...
     */
    public UnvDecode(int maxFrameLength, int lengthFieldOffset, int lengthFieldLength, int lengthAdjustment,
     ...
     *            has been read. If <tt>false</tt>, a
     *            {@link TooLongFrameException}
     *            is thrown after the entire frame that exceeds
     *            <tt>maxFrameLength</tt>
     *            has been read.
     */
    public UnvDecode(int maxFrameLength, int lengthFieldOffset, int lengthFieldLength, int lengthAdjustment,
     ...
     *            has been read.
     */
    public UnvDecode(ByteOrder byteOrder, int maxFrameLength, int lengthFieldOffset, int lengthFieldLength,
                    int lengthAdjustment, int initialBytesToStrip, boolean failFast)
    {
        ...
        // Begin Modified by z00562 结束偏移量增加77ab77ab这个长度
        lengthFieldEndOffset = lengthFieldOffset + lengthFieldLength + 4;
     ...
     * length. The default implementation is
     * capable of decoding the specified region into an unsigned 8/16/24/32/64
     * bit integer. Override this method to
     * decode the length field encoded differently. Note that this method must
     * not modify the state of the specified
     * buffer (e.g. {@code readerIndex}, {@code writerIndex}, and the content of
     * the buffer.)
     *
